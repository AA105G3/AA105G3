    ...
    <div class="container">
        <div class="row">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 text-center select-style">
                		...
                		<div class="col-xs-12 col-sm-4 text-center">
                			<a href="/AA105G3/front-end/chef_order_list/ChefOrderListOfChef_Undone.jsp" class="btn btn-danger btn-lg">未同意</a>
                		</div>
                		
                		<div class="col-xs-12 col-sm-4 text-center">
                			<a href="/AA105G3/front-end/chef_order_list/ChefOrderListOfChef_Done.jsp" class="btn btn-primary btn-lg">未執行</a>
                		</div>
                	</div>
            ...
            <table border='1' bordercolor='#CCCCFF' width='1200'>
				...
				<h2 class="title-style text-center">未同意的會員訂單列表</h2>
