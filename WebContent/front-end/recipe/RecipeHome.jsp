...
<html lang="">
	...
	.recipe-content p,.recipe-content p>a{
		color:#b6b0a5;
	}
	.recipe-content p>a{
		font-size: 16px;
	...
	.recipe-content p>a:hover{
		font-size: 16px;
		color:#e3b13e;	
	}
	.recipe-type-wrapper a:hover{
		color:red;
		text-decoration:none;
	}
				...
				<div class="col-xs-12 col-sm-3 ">
					<div class="news-recipe">
						...
						<div class="recipe-content">
							...
							<p>by <a href="<%=request.getContextPath()%>/member/member.do?action=getMemberInfo&mem_no=${recipeVO.mem_no}" class="recipe-author">${memberSvc.getOneMember(recipeVO.mem_no).mem_name}</a></p>
						</div>
					</div>
				</div>
			</c:forEach>	
