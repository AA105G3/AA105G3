...
<html>
<head>
<title>退款資料修改 - update_chef_refund_input.jsp</title></head>
...
<table border='1' cellpadding='5' cellspacing='0' width='400'>
	<tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
		<td>
		<h3>退款資料修改 - update_chef_refund_input.jsp</h3>
...
<table border="0">
	...
	<tr>
		<td>會員匯款帳號銀行代碼:</td>
		<td><input type="TEXT" name="mem_bnk" size="45"	value="<%=chef_refundVO.getMem_bnk()%>" /></td>
	</tr>
	<tr>
		<td>會員匯款帳號:</td>
		<td><input type="TEXT" name="mem_bnk_ac" size="45"	value="<%=chef_refundVO.getMem_bnk_ac()%>" /></td>
	</tr>
	<tr>
		<td>退款審核狀態:</td>
...
<!-- 將只顯示不修改的欄位，以原值傳回，通常用於PK編號或不易變動的值如姓名 -->
<input type="hidden" name="chef_rfd_no" value="<%=chef_refundVO.getChef_rfd_no()%>">
<input type="hidden" name="chef_ord_no" value="<%=chef_refundVO.getChef_ord_no()%>">
<input type="hidden" name="emp_no" value="<%=chef_refundVO.getEmp_no()%>">
