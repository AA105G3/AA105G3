    ...
    <div class="col-xs-12 col-sm-10" id="chefInfo">
        ...
        <table>
			...
			<tr>
				...
				<td class="cancel-wrapper"><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete_msg" id="del_btn">不通過</button></td>
			</tr>
        </table>
      </div>
    </div>  
         ...
         <!-- Modal -->
		  <div class="modal fade" id="delete_msg" role="dialog" style="margin-top:90px;">
		    ...
		    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/chef/chef.do">
		      ...
		      <div class="modal-content">
		        <div class="modal-header">
		          ...
		          <h3 class="modal-title text-center">審核不通過原因填寫</h3>
		        </div>
		        <div class="modal-body">
		          <textarea name="rej_reason" id="rej_reason" class="form-control" placeholder="請輸入原因..." rows="6" style="resize: none;"></textarea>
		        </div>
		        <div class="modal-footer">
		        	<input type="submit" class="btn btn-primary" name="submitButton" value="送出">
		          	<input type="hidden" name="chef_no" value="${chefVO.chef_no}">
