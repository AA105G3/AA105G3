...
public class FilmVideoWrite {
    ...
    public static void main(String argv[]) {
          ...
          for(int i = 1; i <= 5; i++){
        	  ...
        	  /*String photo = "videoplayback.mp4";*/
        	  
        	  String photo = "0" + i + ".mp4";
        	  
        	  try {
        		  con = DriverManager.getConnection(url, userid, passwd);
        		  File pic = new File("C:\\Users\\cuser\\Desktop\\DBimages\\Film", photo); //相對路徑- picFrom
                                                     //絕對路徑- 譬如:
        		  ...
        		  pstmt = con.prepareStatement("update Film set film_file=? where recipe_no=?");
