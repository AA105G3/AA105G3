...
public class MemberJNDIDAO implements MemberDAO_interface {
	...
	private static final String UPDATE_TEXTONLY = "UPDATE member set mem_name=?, mem_ac=?, mem_pw=?, mem_image=?, mem_sex=?, mem_phone=?, mem_email=?, mem_adrs=?, mem_own=?, mem_history=?, mem_online=? where mem_no = ?";
	private static final String UPDATE2 = "UPDATE member set mem_name=?, mem_ac=?, mem_pw=?, mem_image=?, mem_sex=?, mem_phone=?, mem_email=?, mem_adrs=?, mem_own=?, mem_history=?, mem_online=? where mem_no = ?";
	...
	@Override
	public void updateNoPic(MemberVO memVO) {
		...
		try {
			con = ds.getConnection();
			pstmt = con.prepareStatement(UPDATE_TEXTONLY);
